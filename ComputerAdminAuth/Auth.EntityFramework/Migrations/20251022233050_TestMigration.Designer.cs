...
namespace Auth.EntityFramework.Migrations
{
    ...
    [Migration("20251022233050_TestMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Domain.Entities.TelegramEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Auth.Domain.Entities.UserSession", b =>
                {
                    ...
                    b.Property<DateTime>("SecretCreatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization", b =>
                {
                    ...
                    b.HasIndex("ApplicationId")
                        .HasDatabaseName("IX_OpenIddictAuthorizations_ApplicationId");
            ...
            modelBuilder.Entity("Auth.Domain.Entities.TelegramEntity", b =>
                {
                    b.HasOne("Auth.Domain.Entities.UserEntity", "User")
                        .WithOne()
                        .HasForeignKey("Auth.Domain.Entities.TelegramEntity", "UserId")
